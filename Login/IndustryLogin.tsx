...
const IndustryLogin = ({ navigation }) => {
    ...
    if (isLoggedIn) {
        return <NavigationForIndustry />; // If logged in, render the TabNavigator component
    }
        ...
        >
            <View style={{
                ...
                <View style={{ justifyContent: "center", alignItems: "center" }}>
                    ...
                    <Text style={{ color: "white", fontSize: 60, marginBottom: 20 }}>INDUSTRY</Text>

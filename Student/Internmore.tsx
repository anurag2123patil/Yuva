  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.card}>
        <Text style={styles.title}>React Js Intern</Text>
        <Text style={styles.company}>The Innovative Solutions</Text>
        <Text style={styles.description}>
          Work with and write semantic HTML tags. Work with and write CSS selectors.
          Implement a CSS reset. Understand the box model and how to reset to border-box.
        </Text>
        ...
        <View style={styles.detailRow}>
          <Text style={styles.detailTitle}>Period:</Text>
          <Text style={styles.detailText}>3 months</Text>
        </View>
        ...
        <View style={styles.aboutSection}>
          ...
          <Text style={styles.skillsText}>
            React Js, Bootstrap, HTML, CSS, Designing
          </Text>
        </View>

        <View style={{ height: 50, marginTop: 10, marginLeft: 75 }}>
          <TouchableOpacity onPress={() => navigation.navigate('InternApply')}>

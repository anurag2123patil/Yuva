            ...
            <View style={styles.container}>
                ...
                <View style={styles.listing}>
                    <TouchableOpacity>
                        <View style={styles.listingItem}>
                            <View style={styles.listingImage}>
                                <Image source={require('./photo/neera.jpg')} style={styles.listingImageContent} />
                            </View>
                    ...
                    <View style={styles.listingItem}>
                        ...
                        <View style={styles.listingDetails}>
                            <View style={styles.listingTop}>
                                <Text style={styles.listingTitle}>Rolls-Royce Motor Cars Limited</Text>
                            </View>
                            <View style={styles.listingRating}>
                                <Text style={styles.listingRatingText}>4.1</Text>
                    ...
                    <View style={styles.listingItem}>
                        ...
                        <View style={styles.listingDetails}>
                            <View style={styles.listingTop}>
                                <Text style={styles.listingTitle}>Maruti Suzuki India Limited</Text>
                            </View>
                            <View style={styles.listingRating}>

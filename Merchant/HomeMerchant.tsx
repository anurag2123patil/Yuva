    ...
    return (
        <ScrollView style={styles.body}>
                    ...
                    <View style={styles.card}>
                        <View style={styles.row}>
                            <TouchableOpacity style={styles.blogStyle}
                                onPress={() => navigation.navigate('BlogMerchant')}>
                                <Image
                                    source={require('./photo/blog.png')}
                                    style={styles.blog}
                                />
                                <Text style={{ fontSize: 15, marginTop: 2 }}>Blog</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.indusStyle}
                                onPress={() => navigation.navigate('ChallengesMerchant')}>
                                <Image
                                    source={require('./photo/industry_chal.png')}
                                    style={styles.indus}
                                />
                                <Text style={{ fontSize: 15 }}>Challenges</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.blogStyle}
                            onPress={() => navigation.navigate('JobMerchant')}>
                                <Image
                                    source={require('./photo/job.png')}
                                    style={styles.blog}
                                />
                                <Text style={{ fontSize: 15, marginTop: 4 }}>Job</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={styles.row}>
                            <TouchableOpacity style={styles.blogStyle}
                            onPress={() => navigation.navigate('PolesMerchant')}>
                                <Image
                                    source={require('./photo/poles.png')}
                                    style={styles.blog}
                                />
                                <Text style={{ fontSize: 15, marginTop: 0 }}>Poles</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.indusStyle}
                            onPress={() => navigation.navigate('TalkMerchant')}>
                                <Image
                                    source={require('./photo/talk.png')}
                                    style={styles.indus}
                                />
                                <Text style={{ fontSize: 15 }}>Talks</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.blogStyle}
                            onPress={() => navigation.navigate('InternshipMerchant')}>
                                <Image
                                    source={require('./photo/internship.png')}
                                    style={styles.intern}
                                />
                                <Text style={{ fontSize: 15, marginTop: 4 }}>Internship</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
            ...
            <View style={styles.row3}>
                ...
                onPress={() => navigation.navigate('MerchantViewAll')}>
            ...
            <View style={styles.exploreEventMainView}>
                <View style={styles.exploreEventMainTouch}>
                    ...
                    <View style={{ marginTop: 15, marginLeft: 10 }}>
                        ...
                        <View style={{ flexDirection: "row", alignItems: "center" }}>
                            ...
                            <Text style={{ marginLeft: 15 }}>2024-07-29 Time - 18:30:00</Text>
                        </View>

                        <View style={{ flexDirection: "row", alignItems: "center", marginTop: 10 }}>
                            <Image source={require('./photo/clock.png')} style={{ height: 20, width: 20 }} />
                            <Text style={{ marginLeft: 15 }}>7:00 PM</Text>
                        </View>

                        <View style={{ flexDirection: "row", alignItems: "center", marginTop: 10 }}>
                            <Image source={require('./photo/location.png')} style={{ height: 20, width: 20 }} />
                            <Text style={{ marginLeft: 15, marginRight: 20 }}>Shree sai row Banglow Upendra Nagar Nashik</Text>
                        </View>

                        <View style={{ flexDirection: "row", alignItems: "center", marginTop: 10 }}>
                            <Image source={require('./photo/fees.png')} style={{ height: 20, width: 20 }} />
                            <Text style={{ marginLeft: 15 }}>Fees : 300/-</Text>
                        </View>
                    </View>
                ...
                <View style={styles.row3}>
                    <Text style={styles.tranding}>NEWS</Text>
                     <TouchableOpacity style={styles.exploreTouch}
                     onPress={() => navigation.navigate('NewsMerchant')}>
                        <View style={styles.row2}>
                            <Text style={{ color: "white", fontSize: 20 }}>View All</Text>
                            <Ionicons name="arrow-forward-sharp" size={25} color="white" />
                        </View>
                    ...
                    onPress={() => navigation.navigate('NewsMerchant')}>
                        <View style={{ flexDirection: "row" }}>
                            ...
                            <View style={{ marginTop: 8, marginLeft: 4, justifyContent: "space-between" }}>
                                <Text style={{ fontSize: 16 }}>Mumbai BMW hit-and-run case:</Text>

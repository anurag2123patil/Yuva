                    ...
                    <TouchableWithoutFeedback>
                        <View style={styles.modalContainer}>
                            ...
                            <View style={styles.row}>
                                    <TouchableOpacity style={styles.blogStyle} onPress={()=>navigation.navigate('BlogMerchant')}>
                                    <Image
                                ...
                                <TouchableOpacity style={styles.indusStyle} onPress={()=>navigation.navigate('ChallengesMerchant')}>
                                    <Image
                                ...
                                <TouchableOpacity style={styles.blogStyle} onPress={()=>navigation.navigate('InternshipMerchant')}>
                                    <Image
                                ...
                                <TouchableOpacity style={styles.blogStyle} onPress={()=>navigation.navigate('JobMerchant')}>
                                    <Image
                            ...
                            <View style={styles.row}>
                                <TouchableOpacity style={styles.blogStyle} onPress={()=>navigation.navigate('NewsMerchant')}>
                                    <Image
                                ...
                                <TouchableOpacity style={styles.indusStyle} onPress={()=>navigation.navigate('PodcastMerchant')}>
                                    <Image
                                ...
                                <TouchableOpacity style={styles.blogStyle} onPress={()=>navigation.navigate('PolesMerchant')}>
                                    <Image
                                ...
                                <TouchableOpacity style={styles.blogStyle} onPress={()=>navigation.navigate('TalkMerchant')}>
                                    <Image
